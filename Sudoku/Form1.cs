...
namespace Sudoku
{
    public partial class Form1 : Form
    {
        ...
        public void game_ShowSolution(int[][] grid)
        {
            ...
            if (count == 81) { System.Windows.Forms.MessageBox.Show("Все ячейки заполнены правильно, вы выйграли!", "Игра окончена"); game.NewGame(r); }
            else { System.Windows.Forms.MessageBox.Show("Ячейки не были заполнены верно, вы проиграли!", "Игра окончена"); game.NewGame(r); }
        }
